...
public class ServletEstabelecimentoAlterar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            //Executando o método
            int resultado = estabelecimento.alterar(new EstabelecimentoObj(nome,Double.parseDouble(nota),cep,rua, cidade, estado, foto,Integer.parseInt( tpEst)),Integer.parseInt(id));
